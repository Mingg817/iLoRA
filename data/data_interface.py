        ...
        if p > thresh_hold:
            ...
            for i, sample in enumerate(batch):
                ...
                if '[CansHere]' in input_text:
                    ...
                    # CTR:
                    # CTR_text.append('No')  # 添加CTR文本信息
                
                """# 添加[TargetHere]用于CTR预测
            ...
            for i, sample in enumerate(batch):
                ...
                if '[TargetHere]' in input_text:
                    # CTR: Yes
                    insert_prompt=insert_prompt=", ".join([sample['correct_answer']+' [PH]'])
                    input_text=input_text.replace('[TargetHere]',insert_prompt)  
